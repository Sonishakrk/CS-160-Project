...
public class Pump extends Main{
    private int pumpNumber;
    private double deposit = 0.00;
    private double sale = 0.00;                 
    private double change = 0.00;
    private double pricePerGallon = 4.499;      
    ...
    void putControlsOnPump(Pane pump) {
        ...
        lblPricePerGallon.setMaxSize(50, 23);   
        ...
        btn87.setStyle(" -fx-base: rgb(255,0,0);");
        btn87.setMaxSize(41, 31);     
        ...
        btn91.setStyle(" -fx-base: rgb(255,255,255);"); 
        btn91.setMaxSize(41, 31);         
        ...
        btnDiesel.setStyle(" -fx-base: rgb(0,127,0);  -fx-text-fill: rgb(255,255,255);");  
        btnDiesel.setMaxSize(64, 31);         
        ...
        btnStartStop.setMaxSize(108, 46);         
